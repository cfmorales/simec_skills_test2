...
$(document).ready(function () {
  $('.sheldon_game').find('.list-group-item').click(function () {
    ...
    var humanChoise = $(this).data('choise');
    var browserchoise = Math.floor(Math.random() * (6 - 1)) + 1;
    browserChoise(browserchoise); //game results
  ...
  function gameResults(humanChoise, browserChoise) {
    //comparing results with every alternative
    var gameResultsSelector = $('.gameResults');
  ...
  function saveResults(winner) {
    var sheldon_game_selector = $('.sheldon_game');
    var list_group = sheldon_game_selector.find('.list-group-item');
    var spinner = sheldon_game_selector.find('.spinner-border');
...
__webpack_require__(/*! C:\laragon\www\simec_skills_test\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\simec_skills_test\resources\sass\app.scss */"./resources/sass/app.scss");
